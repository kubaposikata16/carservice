...
import HarmonogramWizytSection from "./MainComponents/HarmonogramWizytSection/HarmonogramWizytSection";
...
const Main = () => {
  ...
  const [showHarmonogramWizytSection, setShowHarmonogramWizytSection] =
    useState(false);
  ...
  const clearAll = () => {
    ...
    setShowHarmonogramWizytSection(false);
  };
  //Przycisk O nas
  const handleOnas = () => {
    clearAll();
  ...
  const handleHarmonogramWizyt = () => {
    clearAll();
    setHeader("Harmonogram Wizyt");
    setShowHarmonogramWizytSection(true);
  };
  //Wylogowywanie się
  const handleLogout = () => {
